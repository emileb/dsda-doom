...
LOCAL_STATIC_LIBRARIES += SDL2_net logwritter zipotg sndfile

LOCAL_SHARED_LIBRARIES := touchcontrols SDL2 SDL2_mixer SDL2_image core_shared saffal GL4ES ogg vorbis fluidsynth
